...
class FunkinSoundTray extends FlxSoundTray {
	...
	public function new() {
		...
		var bg:Bitmap = new Bitmap(getPath("images/soundtray/backgroundVolume", IMAGE));
		bg.x = 10;
		bg.y = 5;
		...
		var backingBar:Bitmap = new Bitmap(getPath('images/soundtray/mute', IMAGE));
		backingBar.x = 10;
		backingBar.y = 5;
		...
		volumeUpSound = 'volume-up';
		volumeDownSound = 'volume-down';
	}
