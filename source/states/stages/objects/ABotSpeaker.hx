...
class ABotSpeaker extends FlxSpriteGroup {
	...
	public function new(x:Float = 0, y:Float = 0) {
		...
		bg = new FlxSprite(90, 20).loadGraphic(Paths.image('stages/phillyStreets/stereoBG'));
		bg.antialiasing = antialias;
		add(bg);

		var vizX:Float = 0;
		var vizY:Float = 0;
		var vizFrames = Paths.getSparrowAtlas('stages/phillyStreets/aBotViz');
		...
		Paths.loadAnimateAtlas(eyes, 'stages/phillyStreets/systemEyes');
		...
		Paths.loadAnimateAtlas(speaker, 'stages/phillyStreets/abotSystem');
